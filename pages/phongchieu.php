                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><button class="btn btn-success" onclick="openEditSuatChieuForm('<?php echo $row['MASC']; ?>', '<?php echo $row['NGAY']; ?>', '<?php echo $row['THOIGIANBATDAU']; ?>')">Cập Nhật</button></td>
                                <td><a href="./pages/deleteSuatChieu.php?sid=<?php echo $row['MASC']; ?>" class="btn btn-danger">Xóa</a></td>
                            </tr>
                    <?php
                        }
                    }
