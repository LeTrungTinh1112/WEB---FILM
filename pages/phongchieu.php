...
<body>
    <div class="container">
        ...
        <div id=contentSuatChieu class="content">
            <div class="box1">
                <button class="btn btn-primary addsuatchieu" data-toggle="modal" data-target="#themSuatChieuModal">Thêm
                    Suất Chiếu</button>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-success"
                                onclick="openEditSuatChieuForm('<?php echo $row['MASC']; ?>', '<?php echo $row['NGAY']; ?>', '<?php echo $row['THOIGIANBATDAU']; ?>')">Cập
                                Nhật</button></td>
                        <td><a href="./pages/deleteSuatChieu.php?sid=<?php echo $row['MASC']; ?>"
            ...
            <form action="./pages/updateSuatChieu.php" method="post" id="suaSuatChieu">
                <div class="modal fade" id="editSuatChieuModal" tabindex="-1" role="dialog"
                    aria-labelledby="editSuatChieuLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit_masuatchieu" name="edit_masuatchieu"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit_thoigianbatdau" name="edit_thoigianbatdau"
                                        class="form-control">
            ...
            <form action="./pages/insertSuatChieu.php" method="post" id="themSuatChieu">
                <div class="modal fade" id="themSuatChieuModal" tabindex="-1" role="dialog"
                    aria-labelledby="themSuatChieuLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="add_thoigianbatdau" name="add_thoigianbatdau"
                                        class="form-control">
        ...
        <div id="contentLoaiGhe" class="content">
            <div class="box1">
                <button class="btn btn-primary themLoaiGhe" data-toggle="modal"
                    data-target="#addLoaiGheModal">Thêm</button>
            </div>
            <table class="table table-hover table-bordered table-striped">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-success"
                                onclick="openEditLoaiGheForm('<?php echo $row['MALOAIGHE']; ?>', '<?php echo $row['TENLOAIGHE']; ?>', '<?php echo $row['PRICE']; ?>')">Cập
                                Nhật</button></td>
                        <td><a href="./pages/deletePhongChieu.php?sid=<?php echo $row['MALOAIGHE']; ?>"
                                class="btn btn-danger">Xóa</a></td>
                    </tr>
                    <?php
                        }
            ...
            <form action="./pages/insertPhongChieu.php" method="post" id="themLoaiGhe">
                <div class="modal fade" id="addLoaiGheModal" tabindex="-1" role="dialog"
                    aria-labelledby="addLoaiGheModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
        ...
        <form action="./pages/updatePhongChieu.php" method="post" id="suaLoaiGhe">
            <div class="modal fade" id="editLoaiGheModal" tabindex="-1" role="dialog"
                aria-labelledby="editLoaiGheModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_maloaighe" name="edit_maloaighe" class="form-control"
                                    readonly>
                            </div>
                            <div class="form-group">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-info"
                                onclick="openSeatMap('<?php echo $row['MAPHONGCHIEU']; ?>')">Xem Ghế</button></td>
                        <td><button class="btn btn-success"
                                onclick="openEditForm('<?php echo $row['MAPHONGCHIEU']; ?>', '<?php echo $row['TENPHONGCHIEU']; ?>', '<?php echo $row['SOGHE']; ?>', '<?php echo $row['TRANGTHAI']; ?>')">Cập
                                Nhật</button></td>
                        <td><a href="./pages/deletePhongChieu.php?id=<?php echo $row['MAPHONGCHIEU']; ?>"
                                class="btn btn-danger">Xóa</a></td>
                    </tr>
                    <?php
                        }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="trangThai" value="1" id="active" class="form-control"
                                        checked>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_maphongchieu" name="edit_maphongchieu" class="form-control"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="edit_tenphongchieu">Tên Phòng Chiếu</label>
                                <input type="text" id="edit_tenphongchieu" name="edit_tenphongchieu"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Trạng Thái</label><br>
                                <label for="active">Đang Hoạt Động</label>
                                <input type="radio" name="edit_trangThai" value="1" id="active" class="form-control"
                                    checked>
                                <label for="inactive">Tạm Dừng Hoạt Động</label>
    ...
    <div class="container">
        <div id="contentGhe" class="content">
            <!-- Filter controls row -->
            <div class="filter-row mb-4 p-3 bg-light rounded">
                <div class="row g-3 align-items-end">
                    <!-- Phòng chiếu -->
                    <div class="col-md-3">
                        <label for="maPhongChieu" class="form-label">Phòng chiếu</label>
                        <select class="form-select" id="maPhongChieu">
                            <?php
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="maLoaiGhe">
                            <?php
                    ...
                    <!-- Hàng ghế -->
                    <div class="col-md-2">
                        <label for="hangGhe" class="form-label">Hàng ghế</label>
                        <select class="form-select" id="hangGhe">
                            <?php
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <button id="showAllButton" class="btn btn-outline-secondary">
            ...
            <!-- Add button -->
            <div class="mb-3">
                <button class="btn btn-success themGhe" data-toggle="modal" data-target="#addGheModal">
                ...
                <table class="table table-hover table-bordered table-striped">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th width="10%">Loại Ghế</th>
                            <th width="8%">STT</th>
                            <th width="10%">Hàng Ghế</th>
                            <th width="10%">Trạng Thái</th>
                            <th width="10%">Mã Ghế</th>
                    ...
                    <tbody>
                        ...
                        $result = $conn->executeQuery($query);
                        if (!$result) {
                            echo '<tr><td colspan="8" class="text-center">Không thể tải dữ liệu</td></tr>';
                        } else {
                            while ($row = mysqli_fetch_assoc($result)) {
                        ?>
                        <tr>
                            <td><?php echo htmlspecialchars($row['MAPHONGCHIEU']); ?></td>
                            <td><?php echo htmlspecialchars($row['MALOAIGHE']); ?></td>
                            <td class="text-center"><?php echo htmlspecialchars($row['STT']); ?></td>
                            <td class="text-center"><?php echo htmlspecialchars($row['HANGGHE']); ?></td>
                            <td><?php echo htmlspecialchars($row['TRANGTHAI']); ?></td>
                            <td><?php echo htmlspecialchars($row['MAGHE']); ?></td>
                            <td class="text-center">
                                <button class="btn btn-sm btn-success"
                                    onclick="openEditGheForm('<?php echo $row['MAPHONGCHIEU']; ?>', '<?php echo $row['MALOAIGHE']; ?>', '<?php echo $row['STT']; ?>', '<?php echo $row['HANGGHE']; ?>', '<?php echo $row['TRANGTHAI']; ?>', '<?php echo $row['MAGHE']; ?>')">
                                    <i class="fas fa-edit"></i> Cập Nhật
                                </button>
                            </td>
                            <td class="text-center">
                                <a href="./pages/deleteGhe.php?id=<?php echo $row['MAGHE']; ?>"
    ...
    <form id="themGhe" action="./pages/insertGhe.php" method="post">
        <div class="modal fade" id="addGheModal" tabindex="-1" role="dialog" aria-labelledby="addLoaiGheModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form action="./pages/updateGhe.php" method="post" id="suaGhe">
        <div class="modal fade" id="editGheModal" tabindex="-1" role="dialog" aria-labelledby="editLoaiGheModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <!-- form hien ghe -->
    <div class="modal fade" id="seatMapModal" tabindex="-1" role="dialog" aria-labelledby="seatMapModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    function validateThemPhongChieuForm() {
        ...
        if (!document.getElementById("them_maphongchieuError")) {
            maPhongChieuInput.insertAdjacentHTML('afterend',
                '<span id="them_maphongchieuError" style="color: red;"></span>');
        }
        if (!document.getElementById("them_tenPhongChieuError")) {
            tenPhongChieuInput.insertAdjacentHTML('afterend',
                '<span id="them_tenPhongChieuError" style="color: red;"></span>');
        }
    ...
    function validateSuaPhongChieuForm() {
        ...
        if (!document.getElementById("edit_tenPhongChieuError")) {
            tenPhongChieuInput.insertAdjacentHTML('afterend',
                '<span id="edit_tenPhongChieuError" style="color: red;"></span>');
        }
    ...
    document.getElementById('filterButton').addEventListener('click', function() {
        ...
        xhr.send('maPhongChieu=' + maPhongChieu + '&maLoaiGhe=' + maLoaiGhe + '&stt=' + stt + '&hangGhe=' +
            hangGhe);
    });
